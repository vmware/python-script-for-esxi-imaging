...
4. Update the documentation, if required. See the `docs` directory for the documentation source.
5. Commit to your fork [using clear commit messages][git-commit]. Please use [Conventional Commits][conventional-commits].
6. Submit a pull request, answering any default questions in the pull request, and linking to any related issues for context. See [GitHub flavored markdown syntax][gh-markdown] for references.
7. Submit a work in progress pull request as a **draft pull request**. Mark the pull request as **ready for review** when you are ready for feedback.
8. Review any automated checks on the the pull request pass.
9. Stay engaged in the pull request review process.
...
[gh-discussions]: https://github.com/vmware/python-script-for-esxi-imaging/discussions
[gh-forks]: https://help.github.com/articles/fork-a-repo/
[gh-issues]:https://github.com/vmware/python-script-for-esxi-imaging/issues
